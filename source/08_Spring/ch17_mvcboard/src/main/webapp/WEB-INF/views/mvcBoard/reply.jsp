...
<body>
	<!-- reply_view.jsp : param.pageNum, param.bid, model 의 Board(원글정보) -->
	<form action="${conPath }/mvcBoard/reply.do" method="post">
		...
		<table>
			<caption>${boardDto.bid }번의 글쓰기</caption>
			<tr>
				<th>작성자</th>
			...
			<tr>
				<th>글제목</th>
				<td><input type="text" name="btitle" required="required" value="[답]${boardDto.btitle.substring(0,1) }"></td>
			</tr>
			<tr>
				<th>본문</th>
