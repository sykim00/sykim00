...
<body>
	<form action="${conPath }/mvcBoard/modify.do" method="post">
		...
		<table>
			...
			<tr>
				<th>작성자</th>
				<td><input type="text" name="bname" value="${boardDto.bname }" required="required"></td>
			</tr>
			<tr>
				<th>제목</th>
				<td><input type="text" name="btitle" value="${boardDto.btitle }" required="required"></td>
			</tr>
			<tr>
				<th>본문</th>
				<td><textarea rows="5" name="bcontent">${boardDto.bcontent }</textarea></td>
			</tr>
			<tr>
				<td colspan="2">
